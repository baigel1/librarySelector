...
const Selector = () => {
        ...
        switch(answers.length){
            case 1: {
                if(answers[0] === 'False') {
                    ...
                    setLibraryDescription("The Answers API is great if you are building a non-web application like a mobile app. It's a REST API used for querying data that contains different endpoints for Universal Search and Vertical Search.")
                }  
                break
            }
            case 2: {
            ...
            case 3: {
                ...
                if (answers[2] === 'True') {
                    ...
                    setLibraryDescription("Headless is our Redux state management library that has React bindings (if you want to use React) but is also general enough to be used in any framework of your choice! (Vue and Angular bindings coming soon)!")
                    ...
                    setLibraryDescription("Answers Core is a TypeScript library that’s used for interacting with the Answers API. It does not require access to the DOM so you can use it in either the browser or Node if you want to.")
            ...
            case 4: {
                if(!foundResult){
                    if (answers[3] === 'True') {
                        ...
                        setLibraryDescription("The React Component Library is great if you are using React and want to get your experience up and running as quickly as possible with some pre-defined components. It contains components for your search bar, results, facets, and more!")

                    }
                    else {
                        setFoundResult(`React Headless!`)
                        setDocumentationLink("https://github.com/yext/answers-headless-react")
                        setLibraryDescription("If you want to use React as well as a library that handles state management for you, but would rather have full control over each component's UI, then this library is perfect for you!")
    ...
    return (
        ...
        <div className="flex flex-col items-center my-16 text-center">
            { foundResult ? 
            <>
                <h1 className="text-7xl">{foundResult} Click <a href={documentationLink} className="text-cyan-800 font-bold">here</a> for documentation</h1>
